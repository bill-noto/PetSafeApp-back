...
<div class="h-2/4 py-10 bg-gradient-to-b from-black to-grey-200">
    <div class="w-4/5 lg:w-3/5 xl:w-3/5 bg-white border border-primary mx-auto p-4">
        <h1 class="text-center text-2xl pb-4">REGISTER</h1>
        <div class="block text-center">
            <form class="mx-auto w-3/5 inline-block text-sm" action="register" method="POST">

                <?php if ($message): ?>
                    <div class="my-4 p-2 w-4/5 mx-auto text-lg sm:text-base bg-red-400">
                        <?= $message ?>
                    </div>
                <?php endif; ?>
